...
describe('Sale Manager Contract Testing', () => {
  ...
  beforeEach(async () => {
    ...
    fixture = createSaleManagerV2(burnAlph.contractId, tokenPair.contractId, rewardDistributor.contractId, saleFlatTemplateFixture.contractId, accountTemplateFixture.contractId, rewardDistributor.states());
